...
* Having **Extension Pack for Java**. <br>
  You can download it
  from [Visual Studio's marketplace]([https://bell-sw.com/pages/downloads/#jdk-17-lts](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-pack](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-pack).
